...
title=Label(root,text="Data Analysis", bd=10,font=("times new roman",40,"bold"),bg="black",fg="blue")
...
m_title=Label(Manage_Frame,text="import file",font=("times new roman",30,"bold"),bg="white",fg="black")
...
#--------graphframe-------------------
graph_frame=Frame(root,bd=4,relief=RIDGE,bg="green")
graph_frame.place(x=500,y=400,width=800,height=280)
